namespace WFormsTicTacToe
{
    public partial class Form1 : Form
    {
        ...
        private bool CheckForWinner()
        {
            ...
            {
                string winner = currentMove == 'x' ? "Zeros" : "Crosses";
                MessageBox.Show($"Winer is {winner}", "Game Over", MessageBoxButtons.OK, MessageBoxIcon.Information);
                foreach (var button in buttons)
                {
        ...
        private void button_Click(object sender, EventArgs e)
        {
            ...
            if (button.BackgroundImage == null)
            {
                ...
                MessageBox.Show("This cell is taken", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        private void startButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Choose difficulty level", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            MessageBox.Show("Game has started", "Game started", MessageBoxButtons.OK, MessageBoxIcon.Information);
